...
export class ScormLauncher {
    ...
    static launch( url: string, name: string = "course", win = window, options: LaunchOptions = new LaunchOptions(new ScreenRelativeSize()) ): any {
        win.open( url, name, options.toString() );
    }
